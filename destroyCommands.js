...
( async () => {
  ...
  console.log( 'YOU CAN NOW STOP THE INSTANCE AND UPDATE THE STARTUP COMMAND TO `index.js`' );
  setTimeout( () => { console.log( 'TIME IS UP!' ); }, 600000 );
  setTimeout( () => { console.log( 'RESTARTING!!!' ); }, 900000 );
} )();
