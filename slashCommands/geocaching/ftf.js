  ...
  options: [// message-id, target, language
    ...
    { type: 3, name: 'language', description: 'Language to give information in.',
      ...
      description_localizations: {
        ...
        pt: 'Língua para dar informações.',
      ...
      choices: [
        ...
        { name: 'Português/Portuguese (Portugal)', value: 'pt' },
  ...
  run: async ( client, interaction ) => {
    try {
      ...
      const i18InvalidMsgId = {
        ...
        pt: 'Não é um id de mensagem valido',
      ...
      const i18NoMessage = {
        ...
        pt: 'Impossivel de encontrar a mensagem exata para responder',
